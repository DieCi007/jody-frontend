    ...
    resources: {
        en: {
            translation: {
                ...
                contact: {
                    title: 'Information or job quotations? Connect with',
                    description: 'Choose a category and send a request. You will be contacted soon.',
                ...
                jobs: {
                    ...
                    description: 'From technicians to specialists in various fields, we are continuously expanding and looking for skilled people. Make sure to enter a contact number and briefly describe your skills and experiences.',
                    aboutYou: 'About you'
                }
            }
        },
        it: {
            translation: {
                ...
                contact: {
                    title: 'Informazioni o preventivi di lavoro? Connettiti con',
                    description: 'Scegli una categoria e invia una richiesta. Sarai contattato al più presto.',
                    number: 'Numero di contatto',
                    info: 'Informazioni',
                    quotation: 'Preventivo di lavori',
                ...
                jobs: {
                    ...
                    description: 'Da tecnici a specialisti in vari campi, siamo in espansione continua e alla ricerca di persone qualificate. Assicurati di inserire un numero di contatto e di descrivere brevemente le tue capacità ed esperienze.',
                    aboutYou: 'Raccontaci di più'
                }
            }
        },
        al: {
            translation: {
                ...
                contact: {
                    title: 'Informacion apo preventiv punimesh? Lidhu me',
                    description: 'Zgjidh një nga kategoritë më poshtë dhe dërgo një kërkesë. Do të kontaktohesh së shpejti.',
                    number: 'Numër kontakti',
                    info: 'Informacion',
                    quotation: 'Preventiv punimesh',
                ...
                jobs: {
                    ...
                    description: 'Nga teknik të lartë te specialist të fushëve të ndryshme, jemi gjithmonë duke u zgjeruar dhe kërkuar njerëz të aftë. Sigurohu të vendosësh një numër kontakti dhe përshkruaj shkurtimisht aftësitë dhe eksperiencat e tua.',
                    aboutYou: 'Dy fjalë rreth teje'
                }
            }
        }
    },
